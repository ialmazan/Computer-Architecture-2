...
# opcodes
opcodes = {
	'ALU'  : '000000', # ADD, SUB, AND, OR, SLT, SLL, SRL, JR, XOR
	'ADDI' : '001000', 
	'ANDI' : '001100', 
	'ORI'  : '001101',
	'BEQ'  : '000100',
...
states = {
	...
	'norm'   : '0111', # add, and, or, slt, sub, xor
	'shift'  : '1000', # sll, srl
...
for x in range(0,65535):
	...
	databutts = get_next_state(state, opcode, funct) #4 bits
	databutts += get_alu_opcode(state, opcode, funct) #3 bits
	databutts += get_reg_dst(state) #2 bits
